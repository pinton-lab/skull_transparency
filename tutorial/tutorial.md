...
Two entry points need different things. If you already have a solved bundle you never touch a CT, a GPU, or MATLAB, so install the core and go straight to placement (Section 6, step 5). If you are bringing your own CT you also need the solver extra and a GPU.
